  ...
  for (let i = 0; i < 60 * 60; i++) {   // up to 60s of boss fight
    ...
    if (!named) {
      ...
      if (names) {
        ...
        // RESTORED 2026-09-17 (owner correction: "I didn't intend on you
        // removing the boss banner completely") — the set-piece boss arrival
        // is the cinematic centre letterbox again; the peripheral warning is
        // scope-limited to the repeated mid-combat herald.
