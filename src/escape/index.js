...
export function explain(px, py) {
  ...
  return 'THE ESCAPE — run right. Gaps are lethal falls, the horde wall behind is the timer, the boss guards the finale (watch each arm\u2019s wind-up tell, then run past on its rest beat — the floor IS the route).';
}
